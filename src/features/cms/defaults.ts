...
const HOME_SECTIONS: SectionSeed[] = [
  { section_key: "hero", section_type: "hero", eyebrow: "TÀ XÙA • VERIFIED LOCAL TRAVEL", heading: "Đi thật. Biết trước.", body: "Chúng tôi trực tiếp thẩm định nơi ở, quay video 360°, chỉ rõ ưu nhược điểm và giúp bạn chuẩn bị chuyến Tà Xùa rõ ràng hơn trước khi lên đường.", cta_label: "Tìm chuyến đi phù hợp", cta_href: "/stay", desktop_media_id: null, mobile_media_id: null, sort_order: 10, is_enabled: true, max_items: null },
