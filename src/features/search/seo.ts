...
export const SEO_LANDING_PAGES = {
  ...
  "homestay-san-may-ta-xua": {
    ...
    description: "Tổng hợp phòng tại Tà Xùa có thông tin hướng nhìn ra núi hoặc thung lũng; chưa được kiểm chứng theo tiêu chuẩn Cloud View Verified.",
    ...
    note: "Thông tin hướng nhìn hiện tại chưa được kiểm chứng theo tiêu chuẩn Cloud View Verified và không bảo đảm có mây. Vui lòng xem ảnh và xác nhận thêm với nơi lưu trú.",
  ...
  "homestay-ta-xua-view-dep": {
    ...
    intro: "Trang này dựa trên hướng nhìn cơ bản đã ghi nhận cho từng loại phòng, không dùng điểm số, xếp hạng hay nhãn Cloud View Verified.",
    criteria: "Chỉ chọn phòng đang công khai có hướng nhìn đã ghi nhận là núi hoặc thung lũng.",
    note: "Thông tin hiện tại chưa được kiểm chứng theo tiêu chuẩn Cloud View Verified. Ảnh hiển thị là ảnh đã duyệt công khai; chưa có điểm Cloud View hoặc vị trí ngắm đã kiểm chứng.",
    preset: { viewTypes: ["mountain", "valley"] },
