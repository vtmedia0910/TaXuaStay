  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      <div className="rounded-3xl bg-pine-soft p-4 text-ink">
        <h3 className="font-display text-lg font-bold text-pine">Điểm chúng tôi thích</h3>
      ...
      <div className="rounded-3xl bg-copper/10 p-4 text-ink">
        <h3 className="font-display text-lg font-bold text-pine">Điều bạn nên biết</h3>
