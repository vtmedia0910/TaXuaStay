...
export const metadata: Metadata = {
  title: "Tà Xùa Stay Verified Standard",
  description: "Cách Tà Xùa Stay kiểm tra đúng phòng, View Thật, Cloud View, đường vào, bằng chứng 360° và thời hạn xác minh.",
...
export default function VerifiedPage() {
  return (
    <main className="bg-cream pb-20">
      <section className="bg-pine px-5 py-14 text-white sm:px-8 sm:py-20">
        <div className="mx-auto max-w-6xl"><Badge className="bg-white text-pine"><ShieldCheck size={16} />TÀ XÙA STAY VERIFIED</Badge><h1 className="mt-5 max-w-4xl font-display text-5xl font-bold sm:text-7xl">Đúng phòng. Đúng view. Yên tâm lên Tà Xùa.</h1><p className="mt-6 max-w-3xl text-lg leading-8 text-white/80">Verified Standard giúp bạn biết thông tin nào đã được kiểm tra, bằng chứng thuộc đúng phòng nào và kết quả còn hiệu lực đến khi nào.</p><Link href="/tim-phong" className={buttonVariants({ variant: "accent", size: "lg", className: "mt-7" })}>Tìm phòng theo nhu cầu</Link></div>
      </section>
      ...
      <div className="mx-auto grid max-w-6xl gap-14 px-5 py-12 sm:px-8">
        <section aria-labelledby="meaning-title"><p className="text-sm font-bold uppercase tracking-[0.14em] text-copper-strong">Chúng tôi kiểm tra điều gì?</p><h2 id="meaning-title" className="mt-2 font-display text-4xl font-bold text-pine">Mỗi badge có một ý nghĩa rõ ràng</h2><div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Card className="p-5"><CheckCircle2 className="text-success" aria-hidden="true" /><h3 className="mt-4 font-bold text-pine">Property Verified</h3><p className="mt-2 text-sm leading-6 text-muted">Danh tính, địa điểm và thông tin liên hệ của nơi lưu trú đã được đối chiếu.</p></Card>
          <Card className="p-5"><ShieldCheck className="text-success" aria-hidden="true" /><h3 className="mt-4 font-bold text-pine">Room Verified</h3><p className="mt-2 text-sm leading-6 text-muted">Thông tin của đúng loại phòng và bằng chứng gắn với phòng đã được xem xét.</p></Card>
          <Card className="p-5"><Eye className="text-copper" aria-hidden="true" /><h3 className="mt-4 font-bold text-pine">Cloud View Verified</h3><p className="mt-2 text-sm leading-6 text-muted">Đánh giá vị trí nhìn thực tế từ đúng loại phòng, không phải dự báo có mây.</p></Card>
          <Card className="p-5"><Mountain className="text-copper" aria-hidden="true" /><h3 className="mt-4 font-bold text-pine">Road Verified</h3><p className="mt-2 text-sm leading-6 text-muted">Đường vào, phương tiện tiếp cận, mặt đường, đoạn khó và chỗ đỗ đã được ghi nhận có thời hạn.</p></Card>
        </div></section>
        ...
        <section className="grid gap-5 sm:grid-cols-2" aria-labelledby="freshness-title"><Card className="p-6"><RefreshCcw className="text-copper" aria-hidden="true" /><h2 id="freshness-title" className="mt-4 font-display text-3xl font-bold text-pine">Xác minh có thời hạn</h2><p className="mt-3 leading-7 text-muted">Property, Room, Cloud View và 360° thường được xem lại sau 12 tháng. Road Verified thường là 6 tháng và cần xem lại sớm hơn sau thay đổi đường, công trình hoặc sự kiện thời tiết lớn. Badge tự biến mất khi hết hạn.</p></Card><Card className="p-6"><CloudSun className="text-copper" aria-hidden="true" /><h2 className="mt-4 font-display text-3xl font-bold text-pine">Những điều badge không bảo đảm</h2><ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-muted"><li>Không bảo đảm mây hoặc thời tiết.</li><li>Không xác nhận phòng còn trống theo ngày.</li><li>Không xác nhận hay bảo đảm giá.</li><li>Không bảo đảm đường luôn an toàn trong mọi điều kiện tương lai.</li><li>Không phải chứng nhận pháp lý.</li></ul></Card></section>
      </div>
    </main>
  );
}
