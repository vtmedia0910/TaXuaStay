...
**Current product state:** Legacy Foundation 001–008 + V2 Phase 1 / migration 009 + V2 Phase 2 / migration 010 + application-only V2 Phase 2.5 + V2 Phase 2.6 / migrations 011–014 + V2 Phase 2.6H / migration 015 + V2 Phase 3 / migration 016 + corrective V2 Phase 3H / migration 017 + V2 Phase 4 / migrations 018–020 + V2 Phase 5 / migrations 021–022 + V2 Phase 6 / migration 023 + application-only V2 Phase 7 + V2 Phase 8 / migrations 024–026 + V2 Phase 9 / migrations 027–028 + V2 Phase 10 / corrective migration 029 + V2 Phase 11 / migrations 030–032 + V2 Phase 12 / migration 033 + application-only V2 Phase 12H + application-only V2 Phase 13 + Phase 13A controls + V2 Phase 13B / migration 034 đã hoàn thành. Phase 13B adds a code-owned Gemini/OpenAI/DeepSeek registry, immutable runtime/profile revisions, Behavior Studio and Prompt Lab while retaining the nine read-only tools and Phase 13A shared quota/budget/kill-switch controls. Migration 034 contains metadata only and creates no ACTIVE runtime. Production inference remains disabled until the owner configures a provider credential and passes explicit health, Prompt Lab, activation and controlled smoke verification. The model has no direct Supabase/private-table access or write tool. Chưa có Payment transaction/paid state/QR/link/payment webhook/refund/settlement, customer account hoặc service vertical mới. Phase 12Q Staging/E2E QA infrastructure vẫn deferred theo quyết định owner.

**Latest application extension:** V2 Phase 13C — Assistant Discovery & Embedded Chat UX adds a restrained local cooldown teaser and lazy mobile/desktop embedded chat that reuse the locked Phase 13–13B runtime. Discovery/open causes zero provider calls, sensitive routes are suppressed, and migrations remain 001–034.
