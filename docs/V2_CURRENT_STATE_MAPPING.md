...
Generic standalone Services, motorbike fleet operations/live integration, Bus, unified Booking, Booking Items, Supplier Confirmation, supplier tasks, Payment, Trip Operations, and Trip Dashboard do not exist. Trip Finder creates no request record, hold, booking, profile or payment. The Phase 5 motorbike projection and Phase 6 Package inquiry retain their confirmation boundaries. Transport remains clearly marked future. Combo is shown as usable only when at least one genuine published Package passes public eligibility; otherwise it remains `Sắp có`. Supplier/Partner status and private economics do not change verification, price confidence, availability, search ranking or Trip Finder ranking.
